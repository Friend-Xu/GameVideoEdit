...
class OCRProcessor(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            last_valid_frame_count = self.start_frame  # 记录最后一个有效帧的编号
            ...
            while cap.isOpened() and not self.cancelled and frame_count < max_frame_attempts:
                ...
                try:
                    ...
                    # 更新进度 (线程ID, 当前帧, 当前进度)
                    segment_progress = min(100.0, (frame_count - self.start_frame) / (self.end_frame - self.start_frame) * 100)
...
class OCRProcessDialog(QDialog):
    ...
    def __init__(self, initial_dir="", parent=None):
        ...
        self.thread_count_spin.setValue(10)
