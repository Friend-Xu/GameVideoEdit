...
def putChineseText(image, text, position, color, font_size=20):
    """使用PIL绘制中文后合并到OpenCV图像"""
...
if __name__ == "__main__":
    ...
    with open(r'D:\Github\GameVideoEdit\Video\123eplay_Final1735458759_annotations.json', 'r', encoding='utf-8') as f:
        video_data = json.load(f)

    # 选项1: 在指定帧上绘制并保存
    output_image_path = "D:/Github/GameVideoEdit/Output/annotated_frame.jpg"
